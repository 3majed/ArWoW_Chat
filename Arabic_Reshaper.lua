...
function BB_CreateTestLine()
   BB_TestLine = CreateFrame("Frame", "BB_TestLine", UIParent);
   BB_TestLine:SetHeight(150);
   BB_TestLine:SetWidth(DEFAULT_CHAT_FRAME:GetWidth() + 50);
   BB_TestLine:ClearAllPoints();
   BB_TestLine:SetPoint("TOPLEFT", UIParent, "TOPLEFT", 20, -300);
   local BBchild = CreateFrame("Frame", nil, BB_TestLine);
   BBchild:SetPoint("TOPLEFT", BB_TestLine, "TOPLEFT", 0, 0);
